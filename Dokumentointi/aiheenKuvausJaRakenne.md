...
Toteutetaan peli, jonka avulla pystyy pelaamaan ristinollaa, kuten sit‰ pelattaisiin toruspinnalla. Torus on matemaattinen rakenne, josta voi lukea lisää mm. tästä Wikipedia-artikkelista: http://fi.wikipedia.org/wiki/Torus. Pelattaessa siis toruspinnalla pelaajan täytyy huomioida rakenne ja nähdä monet voittomahdollisuudet, sillä voittosuora ei välttämättä visuaalisesti ole suora.
